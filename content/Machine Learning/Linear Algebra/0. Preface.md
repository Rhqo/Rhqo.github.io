...
==Chapter 6==에서 eigen values와 eigen vectors에 대해 배운 후, Chapter 7.1에서 singular value에 대해 다룰 것이다.
...
Deep Learning에서 matrix weights의 중요한 계산을 위해, Chapter 9에서는 **optimization**의 아이디어를 다루고 있다. \
