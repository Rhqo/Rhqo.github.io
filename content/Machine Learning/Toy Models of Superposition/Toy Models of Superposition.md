...
기본 특징이 밀집 영역에서 다른 방향들과 구별되지 않는다는 사실이 없다면 1(dedicate) 선도 있을 것이라 믿습니다. 
이러한 여러 구성 중 몇 가지는 유명한 톰슨 문제의 해로 떠오를 수 있습니다. (특히 정사각형 안티프리즘은 입방체보다 덜 유명하지만 톰슨 문제의 해로 인해 분자 기하학에서 중요한 역할을 합니다.) 이전에 보았듯이, 우리의 모델은 일반화된 톰슨 문제를 해결하는 것으로 이해될 수 있는 매우 실질적인 의미가 있습니다. 우리의 모델이 특징을 표현하기로 선택할 때, 그 특징은 n차원 구상에 점으로 임베딩됩니다.