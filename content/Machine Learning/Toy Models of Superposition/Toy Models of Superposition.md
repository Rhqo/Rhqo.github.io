...
1. 추가 특징을 단순히 나타내지 않을 수 있습니다 – 이를 $W{\perp}$로 표현하겠습니다. 또는 다른 특징 중 하나를 무시할 수도 있습니다, \( W \).
그러나 흥미로운 점은 중첩을 사용하여 반대 쌍을 만드는 두 가지 방법이 있다는 것입니다. 우리는 "추가 특징"을 다른 하나( \( W \) )와 반대 쌍으로 배치하거나, 다른 두 특징을 중첩시키고 추가 특징에 전용 차원을 부여할 수 있습니다 ( \( W_{\perp} \) ). 이러한 해결책에 대한 폐쇄 형태의 손실에 대한 자세한 내용은 이 노트북에서 확인할 수 있습니다. 모든 특징을 공동 중첩으로 두는 마지막 해결책인 \( W \)에 대해서는 고려하지 않습니다.
![[TMS_14.png]]
